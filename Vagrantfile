...
Vagrant.configure(2) do |config|
  ...
  config.vm.network "forwarded_port", guest: 5984, host: 5986, auto_correct: true
  config.vm.network "forwarded_port", guest: 8080, host: 8086, auto_correct: true
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    mkdir -p ole
    cd ole
    #wget https://github.com/open-learning-exchange/BeLL-Apps/archive/0.12.93.zip
    #unzip 0.12.93.zip
    ...
    echo '"127.0.0.1": "http://127.0.0.1:5986/apps/_design/bell/MyApp/index.html",' >> server.js
    echo '"localhost": "http://localhost:5986/apps/_design/bell/MyApp/index.html"' >> server.js
    echo '}' >> server.js
